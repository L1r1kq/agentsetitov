...
Локальная мультиагентная система **Agentse MedInfo**: жалобы и симптомы → структурирование → поиск в локальном справочнике `knowledge/` → справочный отчёт **без диагноза**.
...
python3 -m agentse chat "Температура 38.2 и сухой кашель три дня, одышки нет. Справочный отчёт, без диагноза."
